                ...
                <tbody>
                    ...
                    <?php foreach ($menu as $m) : ?>
                        <tr>
                            ...
                            <td><?= $m['menu']; ?></td>
                            <td>
                                <a href="" class="btn btn-success" data-toggle="modal" data-target="#exampleModalmenuedit<?= $m['id']; ?>" data-placement="top" title="edit">Edit</a><a href="<?= base_url('menu/hapusmenu/'); ?><?= $m['id'] ?>" class="btn btn-danger" onclick="return confirm('Yakin dek?')
                                ">delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
